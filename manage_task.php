	...
	<form action="" id="manage-task">
		...
		<div class="form-group">
			...
			<select name="priority" id="priority" class="custom-select custom-select-sm">
				<option value="Important" <?php echo isset($priority) && $priority == "Important" ? 'selected' : '' ?>>Important</option>
				<option value="Urgent" <?php echo isset($priority) && $priority == "Urgent" ? 'selected' : '' ?>>Urgent</option>
				<option value="Delegated" <?php echo isset($priority) && $priority =="Delegated"  ? 'selected' : '' ?>>Delegated</option>
				
				<option value="Deleted" <?php echo isset($priority) && $priority == "Deleted" ? 'selected' : '' ?>>Deleted </option>
			</select>
		</div>
	</form>
</div>
